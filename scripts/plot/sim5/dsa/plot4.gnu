...
OUTPUT_FILE = "./../../../../plots/sim5/dsa/figure4.ps"
...
plot \
	CLIENT_INPUT_FILE using 1:6 with lp ls 5 title "DHCPREQUEST packet", \
	CLIENT_INPUT_FILE using 1:7 with lp ls 7 title "DHCPREQUEST authentication option", \
	CLIENT_INPUT_FILE using 1:8 with lp ls 4 title "DHCPACK packet", \
	CLIENT_INPUT_FILE using 1:9 with lp ls 6 title "DHCPACK authentication option"
