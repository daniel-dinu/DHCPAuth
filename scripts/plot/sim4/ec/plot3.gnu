...
OUTPUT_FILE = "./../../../../plots/sim4/ec/figure3.ps"


#set title "EC signature processing time on DHCP server"
...
plot \
	SERVER_INPUT_FILE using 2:xtic(1) with lp ls 2 title "DHCPACK", \
	SERVER_INPUT_FILE using 3:xtic(1) with lp ls 4 title "DHCPACK authentication option"
