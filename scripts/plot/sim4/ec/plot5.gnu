...
OUTPUT_FILE = "./../../../../plots/sim4/ec/figure5.ps"
...
plot \
	SERVER_INPUT_FILE using 5:xtic(1) with lp ls 3 title "DHCPACK packet", \
	SERVER_INPUT_FILE using 6:xtic(1) with lp ls 4 title "DHCPACK authentication option"
