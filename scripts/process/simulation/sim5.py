...
def process_rsa():
    """
    Process sim5 RSA results
    :return:
    """

    client_dat_file = constants.CLIENT_DAT_FILE_FORMAT.format(constants.SIM5_FILE, constants.RSA_FILE)
    server_dat_file = constants.SERVER_DAT_FILE_FORMAT.format(constants.SIM5_FILE, constants.RSA_FILE)
    ...
    for i in range(0, 100 + 1, 1):
        client_results_file = constants.CLIENT_RESULTS_FILE_FORMAT.format(constants.SIM5_FILE, constants.RSA_FILE,
                                                                          str(i).zfill(3))
        server_results_file = constants.SERVER_RESULTS_FILE_FORMAT.format(constants.SIM5_FILE, constants.RSA_FILE,
                                                                          str(i).zfill(3))
