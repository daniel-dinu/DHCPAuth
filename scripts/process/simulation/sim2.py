...
def process_rsa():
    """
    Process sim2 RSA results
    :return:
    """

    client_dat_file = constants.CLIENT_DAT_FILE_FORMAT.format(constants.SIM2_FILE, constants.RSA_FILE)
    server_dat_file = constants.SERVER_DAT_FILE_FORMAT.format(constants.SIM2_FILE, constants.RSA_FILE)
    ...
    for i in range(1024, 4096 + 1, 32):
        client_results_file = constants.CLIENT_RESULTS_FILE_FORMAT.format(constants.SIM2_FILE, constants.RSA_FILE, i)
        server_results_file = constants.SERVER_RESULTS_FILE_FORMAT.format(constants.SIM2_FILE, constants.RSA_FILE, i)
