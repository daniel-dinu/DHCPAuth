...
SERVER_PRIVATE_KEY_FILE_PATH=./../../../../generated/set2/pki/dsa/key

# The server statistics file path
SERVER_STATISTICS_FILE_PATH=./../../../../results/sim4/server/dsa


# DSA key size range
DSA_KEY_SIZE_START=512
DSA_KEY_SIZE_STOP=7680
DSA_KEY_SIZE_STEP=512
...
do
	...
	server_private_key=$SERVER_PRIVATE_KEY_FILE_PATH/key_dsa_$i.pem
