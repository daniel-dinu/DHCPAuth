...
SERVER_PRIVATE_KEY_FILE_PATH=./../../../../generated/set3/pki/rsa/key

# The client public key file path
CLIENT_PUBLIC_KEY_FILE_PATH=./../../../../generated/set3/pgp/rsa/pub

# The owner trust file path
CLIENT_TRUST_FILE_PATH=./../../../../generated/set3/pgp/rsa/trust

# The server statistics file path
SERVER_STATISTICS_FILE_PATH=./../../../../results/sim5/server/rsa
...
do
	echo "---> Simulate server for $RSA_KEY_SIZE bits RSA key pair $i <---"
	...
	server_private_key=$SERVER_PRIVATE_KEY_FILE_PATH/key_rsa_$n.pem
	client_public_key=$CLIENT_PUBLIC_KEY_FILE_PATH/pub_rsa_$n.key
	owner_trust_file=$CLIENT_TRUST_FILE_PATH/owner_rsa_$n.trust
	server_statistics_file=$SERVER_STATISTICS_FILE_PATH/statistics_rsa_$n.csv
