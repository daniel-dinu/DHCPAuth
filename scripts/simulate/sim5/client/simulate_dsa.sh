...
CLIENT_PRIVATE_KEY_FILE_PATH=./../../../../generated/set3/pgp/dsa/priv

# The server certificate file path
SERVER_CERTIFICATE_FILE_PATH=./../../../../generated/set3/pki/dsa/cert

# The client statistics file path
CLIENT_STATISTICS_FILE_PATH=./../../../../results/sim5/client/dsa
...
do
	echo "---> Simulate client for $DSA_KEY_SIZE bits DSA key pair $i <---"
	...
	client_private_key=$CLIENT_PRIVATE_KEY_FILE_PATH/priv_dsa_$n.key
	server_certificate=$SERVER_CERTIFICATE_FILE_PATH/cert_dsa_$n.pem
	destination_server_certificate=/var/db/cert/cert_$n.pem
	client_statistics_file=$CLIENT_STATISTICS_FILE_PATH/statistics_dsa_$n.csv
