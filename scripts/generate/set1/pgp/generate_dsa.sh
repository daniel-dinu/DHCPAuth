...
do
	echo "---> Generate $i bits DSA PGP key pair <---"

	
	private_key_file=$GENERATED_PRIVATE_KEY_FILE_PATH/priv_dsa_$i.key
	public_key_file=$GENERATED_PUBLIC_KEY_FILE_PATH/pub_dsa_$i.key
	owner_trust_file=$GENERATED_OWNER_TRUST_FILE_PATH/owner_dsa_$i.trust
